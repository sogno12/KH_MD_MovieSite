...
public Review(int reviewNo, int memberNo, int movieNo, String reviewText, int reviewRating, String blindStatus) {
	super();
...
public String toString() {
	return "Review [reviewNo=" + reviewNo + ", memberNo=" + memberNo + ", movieNo=" + movieNo + ", reviewText="
			+ reviewText + ", reviewRating=" + reviewRating + ", blindStatus=" + blindStatus + "]";
}
