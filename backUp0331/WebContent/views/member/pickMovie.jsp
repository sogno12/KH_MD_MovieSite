...
<div class="wrap">
 <div class="title1">
    ...
    <div class="sort">
        <button class="button button-color02 block" id="mypick" type="button" onclick="<%=contextPath%>/pickMovie.do">내가 '찜'한 영화</button>
        <button class="button button-color02 block" id="mywatched" type="button" onclick="<%=contextPath%>/watchedMovie.do">내가 본 영화</button>
    </div>
 </div>
